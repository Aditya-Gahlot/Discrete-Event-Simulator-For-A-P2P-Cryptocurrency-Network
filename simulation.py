...
class Simulator(object):
    ...
    def __init__(self, n, z, tm, bm):
        ...
        # Mean transaction inter arrival time
        self.tm = tm

        # Mean block inter arrival time
        self.bm = bm
        ...
        self.prop_delay = [
            # From assignment: Pij can be chosen from a uniform distribution between 10ms and 500ms
